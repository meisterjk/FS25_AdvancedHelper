...
source(advancedHelper.modDirectory .. "scripts/core/advancedHelperConfig.lua")
source(advancedHelper.modDirectory .. "scripts/lifecycle/advancedHelperDebug.lua")
source(advancedHelper.modDirectory .. "scripts/core/advancedHelperWorker.lua")
source(advancedHelper.modDirectory .. "scripts/core/advancedHelperManager.lua")
source(advancedHelper.modDirectory .. "scripts/lifecycle/advancedHelperPayroll.lua")
source(advancedHelper.modDirectory .. "scripts/hooks/advancedHelperFuelHook.lua")
source(advancedHelper.modDirectory .. "scripts/hooks/advancedHelperSpeedHook.lua")
source(advancedHelper.modDirectory .. "scripts/hooks/advancedHelperDamageHook.lua")
source(advancedHelper.modDirectory .. "scripts/hooks/advancedHelperHotspot.lua")
source(advancedHelper.modDirectory .. "scripts/hooks/advancedHelperSafeguard.lua")
source(advancedHelper.modDirectory .. "scripts/integration/advancedHelperAutoDriveHook.lua")
source(advancedHelper.modDirectory .. "scripts/integration/advancedHelperCourseplayHook.lua")
...
function advancedHelper:deleteMap()
    ...
    advancedHelperHotspot.uninstall()
    advancedHelperHotspot:removeAll()
